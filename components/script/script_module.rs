...
pub(crate) fn resolve_imports_match(
    ...
    for (specifier_key, resolution_result) in specifier_map {
        ...
        // TODO: is it necessasy to convert str to utf16 (UTF16CodeUnits) ?
        ...
        if specifier_key.ends_with('\u{002f}') &&
            ...
            (as_url.is_none() || as_url.unwrap().is_special_scheme())
        {
            ...
            assert!(resolution_result.as_str().ends_with('\u{002f}'));
